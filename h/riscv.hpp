...
enum Interrupts {
    ...
    SUPER_ECALL = 0x0000000000000009UL,
    SOFTWARE_I = 0x8000000000000001UL,
    EXTERNAL_I = 0x8000000000000009UL
};
...
public:
    ...
    static BoundedBuffer* bufferIn;
    static BoundedBuffer* bufferOut;
};
